...
message['from'] = 'bright S'
message['to'] = 'fake123@gmail.com'
...
with smtplib.SMTP(host='smtp.gmail.com', port=587) as smtp:
    smtp.ehlo()
    smtp.starttls()
    smtp.login('fake123@gmail.com', 'fake_password')
...
load_dotenv()
gaode_api_key = os.getenv('gaode_key')
...
password_box.send_keys(os.getenv('github_key'))
password_box.submit()
